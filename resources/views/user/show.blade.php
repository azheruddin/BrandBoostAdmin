            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('update-user', $user->id) }}" method="POST">
                        ...
                        <button type="submit" class="btn {{ $user->active == 1 ? 'btn-success' : 'btn-danger' }}">
                            {{ $user->active == 1 ? 'Active' : 'Inactive' }}
                        </button>
                        <br>
                        <small class="status-text text-muted">
                            {{ $user->active == 1 ? 'Click to deactivate' : 'Click to activate' }}
                        </small>
                    </form>
                </td>
                <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <!-- View Link -->
                            <a class="dropdown-item" href="{{ route('view-user', $user->id) }}">View</a>
                            <!-- Edit Link -->
